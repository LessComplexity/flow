#!/usr/bin/env python3
"""Build MapalIcons.ttf — one glyph, the Mapal mark, at U+F8F0.
...
logos in a terminal. Mapal's mark is in no font, so to get the same effect it has to
be put in one.
...
robust than curve approximation.
    ...
    python3 assets/font/build_mapal_icons.py            # -> assets/font/MapalIcons.ttf
"""
...
def main():
    out = pathlib.Path(__file__).parent / "MapalIcons.ttf"
    ...
    fb.setupNameTable(
        {
            "familyName": "MapalIcons",
            "styleName": "Regular",
            "uniqueFontIdentifier": "MapalIcons-Regular-0.1",
            "fullName": "MapalIcons Regular",
            "psName": "MapalIcons-Regular",
            "version": "Version 0.1",
            "manufacturer": "The Mapal project",
