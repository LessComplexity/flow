...
entry:
  ...
  %o3 = alloca [65536 x float]
  %o4 = alloca [65536 x float]
  %o5 = alloca [256 x i32]
  %o6 = alloca { ptr, ptr, ptr, ptr }
  %o7 = alloca [65536 x float]
  %o8 = alloca { ptr, i32 }
  %o9 = alloca float
  %o10 = alloca float
  %o12 = alloca { ptr, i32 }
...
bb22:
  ...
  %t29 = getelementptr [65536 x float], ptr %o3, i64 0, i64 %t24
...
bb33:
  ...
  %t40 = getelementptr [65536 x float], ptr %o4, i64 0, i64 %t35
...
bb48:
  ...
  %t61 = getelementptr [65536 x float], ptr %o7, i64 0, i64 %t50
...
bb49:
  ...
  %t68 = getelementptr [65536 x float], ptr %o7, i64 0, i64 %t67
  ...
  %t73 = getelementptr [65536 x float], ptr %o7, i64 0, i64 %t72
...
entry:
  ...
  %t10 = getelementptr { float, [256 x i32] }, ptr %o10, i32 0, i32 0
  store float 0x0000000000000000, ptr %t10
  %t11 = load ptr, ptr %o2
  %t12 = getelementptr { float, [256 x i32] }, ptr %o10, i32 0, i32 1
  ...
  %t21 = getelementptr { float, [256 x i32] }, ptr %o10, i32 0, i32 0
