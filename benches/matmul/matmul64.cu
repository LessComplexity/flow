...
static __device__ float d_fn3(FlowProd_floatp_floatp_int32_t_int32_t_float_int32_t in);
static __device__ float d_fn4(FlowProd_floatp_floatp_int32_t in);
...
static __device__ float d_fn3(FlowProd_floatp_floatp_int32_t_int32_t_float_int32_t in) {
  ...
  o3 = in.f1;
  o7 = in.f5;
  int64_t t0 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)in.f2 * (uint32_t)64)) + (uint32_t)o7));
...
static __device__ float d_fn4(FlowProd_floatp_floatp_int32_t in) {
  ...
  o4 = in.f2;
  o10.f4 = 0e0f;
  for (unsigned long long t0 = 0; t0 < 64ULL; t0++) {
    o5[t0] = (int32_t)t0;
  }
  o10.f0 = o2;
  o10.f1 = o3;
  ...
  pair.f2 = o10.f2;
  pair.f3 = o10.f3;
  for (unsigned long long t2 = 0; t2 < 64ULL; t2++) {
    pair.f4 = t1;
    pair.f5 = o5[t2];
    t1 = d_fn3(pair);
  }
...
__global__ void k0_4(float* out, int32_t* in, float* cap0, float* cap1) {
  unsigned long long i = (unsigned long long)blockIdx.x * blockDim.x + threadIdx.x;
  if (i < 4096ULL) {
...
static void flow_main() {
  ...
  float* o4 = nullptr;
  float* o5 = nullptr;
  FlowProd_floatp_floatp_int32_tp o6;
  float* o7 = nullptr;
  float o9;
  float o11;
  float o12;
  ...
  float* t0 = nullptr;
  float* t1 = nullptr;
  cu_check(cudaMalloc((void**)&arena0, 82432ULL), "cudaMalloc(arena0)");
