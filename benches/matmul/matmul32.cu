...
static __device__ float d_fn1(FlowProd_floatp_floatp_int32_t_int32_t_float_int32_t in) {
  ...
  o3 = in.f1;
  o7 = in.f5;
  int64_t t0 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)in.f2 * (uint32_t)32)) + (uint32_t)o7));
  int64_t t1 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)o7 * (uint32_t)32)) + (uint32_t)in.f3));
...
static __device__ float d_fn2(FlowProd_floatp_floatp_int32_t in) {
  ...
  o4 = in.f2;
  o10.f4 = 0e0f;
  for (unsigned long long t0 = 0; t0 < 32ULL; t0++) {
    o5[t0] = (int32_t)t0;
  }
  o10.f0 = o2;
  o10.f1 = o3;
  ...
  pair.f2 = o10.f2;
  pair.f3 = o10.f3;
  for (unsigned long long t2 = 0; t2 < 32ULL; t2++) {
    pair.f4 = t1;
    pair.f5 = o5[t2];
    t1 = d_fn1(pair);
  }
...
static void flow_main() {
  ...
  float* t2 = nullptr;
  float* t3 = nullptr;
  cu_check(cudaMalloc((void**)&arena0, 16896ULL), "cudaMalloc(arena0)");
  ...
  o4 = (int32_t*)(arena0 + 8192ULL);
  k0_0<<<(unsigned int)((1024ULL + 255ULL) / 256ULL), 256>>>(o4, 1024);
  o5.f0 = o2;
  o5.f1 = o3;
  o5.f2 = o4;
  o6 = (float*)(arena0 + 12288ULL);
  k0_1<<<(unsigned int)((1024ULL + 255ULL) / 256ULL), 256>>>(o6, o4, o2, o3);
  t2 = (float*)(arena0 + 16384ULL);
  k0_2<<<1, 1>>>(t2, o6, (int64_t)0);
  cu_check(cudaMemcpy(&o8, t2, sizeof(float), cudaMemcpyDeviceToHost), "cudaMemcpy(index)");
  t3 = (float*)(arena0 + 16640ULL);
  k0_2<<<1, 1>>>(t3, o6, (int64_t)1023);
