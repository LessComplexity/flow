...
entry:
  ...
  %o3 = alloca [262144 x double]
  %o4 = alloca [262144 x double]
  %o5 = alloca [512 x i32]
  %o6 = alloca { ptr, ptr, ptr, ptr }
  %o7 = alloca [262144 x double]
  %o8 = alloca { ptr, i32 }
  %o9 = alloca double
  %o10 = alloca double
  %o12 = alloca { ptr, i32 }
...
bb22:
  ...
  %t29 = getelementptr [262144 x double], ptr %o3, i64 0, i64 %t24
...
bb33:
  ...
  %t40 = getelementptr [262144 x double], ptr %o4, i64 0, i64 %t35
...
bb48:
  ...
  %t61 = getelementptr [262144 x double], ptr %o7, i64 0, i64 %t50
...
bb49:
  ...
  %t68 = getelementptr [262144 x double], ptr %o7, i64 0, i64 %t67
  ...
  %t73 = getelementptr [262144 x double], ptr %o7, i64 0, i64 %t72
...
entry:
  ...
  %t10 = getelementptr { double, [512 x i32] }, ptr %o10, i32 0, i32 0
  store double 0x0000000000000000, ptr %t10
  %t11 = load ptr, ptr %o2
  %t12 = getelementptr { double, [512 x i32] }, ptr %o10, i32 0, i32 1
  ...
  %t21 = getelementptr { double, [512 x i32] }, ptr %o10, i32 0, i32 0
