...
entry:
  %o2 = alloca [4096 x i32]
  %o3 = alloca [4096 x float]
  %o4 = alloca [4096 x float]
  %o5 = alloca { ptr, ptr }
  %o6 = alloca [4096 x float]
  %o7 = alloca { ptr, i32 }
  %o8 = alloca float
...
bb3:
  ...
  store i32 4095, ptr %t10
  store i64 0, ptr %s11
  br label %bb12
bb12:
  %t15 = load i64, ptr %s11
  %t16 = icmp uge i64 %t15, 4096
  br i1 %t16, label %bb14, label %bb13
bb13:
  %t17 = getelementptr [4096 x i32], ptr %o2, i64 0, i64 %t15
  %t18 = load i32, ptr %t17
  %t19 = call float @fn3(i32 %t18)
  %t20 = getelementptr [4096 x float], ptr %o3, i64 0, i64 %t15
...
bb23:
  ...
  %t27 = icmp uge i64 %t26, 4096
  br i1 %t27, label %bb25, label %bb24
bb24:
  %t28 = getelementptr [4096 x i32], ptr %o2, i64 0, i64 %t26
  %t29 = load i32, ptr %t28
  %t30 = call float @fn4(i32 %t29)
  %t31 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t26
  store float %t30, ptr %t31
  %t32 = add i64 %t26, 1
...
bb25:
  ...
  %t39 = call [4096 x float] @fn1({ ptr, ptr } %t38)
  store [4096 x float] %t39, ptr %o6
  ...
  %t45 = getelementptr [4096 x float], ptr %o6, i64 0, i64 %t44
  ...
  %t50 = getelementptr [4096 x float], ptr %o6, i64 0, i64 %t49
