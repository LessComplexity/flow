...
%Frame = type { [4096 x i32], [4096 x i32], [4096 x float], [4096 x float], { ptr, ptr, ptr }, [4096 x float], { ptr, i32 }, float, { ptr, i32 }, float, float, float, ptr }

@ckpt0_entries = private unnamed_addr constant [4 x i64] [i64 8589934591, i64 12884901893, i64 17179869190, i64 25769803786]
@ckpt1_entries = private unnamed_addr constant [4 x i64] [i64 8589934591, i64 12884901893, i64 17179869190, i64 25769803786]
...
bb2:
  ...
  %t7 = getelementptr [4096 x i32], ptr %o2, i64 0, i64 %t4
  store i32 %t6, ptr %t7
  %t8 = add i64 %t4, 1
  store i64 %t8, ptr %s0
  br label %bb1
...
bb2:
  %t6 = trunc i64 %t4 to i32
  %t7 = getelementptr [4096 x i32], ptr %o3, i64 0, i64 %t4
  store i32 %t6, ptr %t7
  %t8 = add i64 %t4, 1
  store i64 %t8, ptr %s0
  br label %bb1
...
bb1:
  ...
  br i1 %t5, label %bb3, label %bb2
bb2:
  %t6 = getelementptr [4096 x i32], ptr %o2, i64 0, i64 %t4
  %t7 = load i32, ptr %t6
  %t8 = call float @fn1(i32 %t7)
  %t9 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t4
...
bb2:
  ...
  %t9 = getelementptr [4096 x float], ptr %o5, i64 0, i64 %t4
  store float %t8, ptr %t9
  %t10 = add i64 %t4, 1
  store i64 %t10, ptr %s0
  br label %bb1
...
entry:
  ...
  %o4 = getelementptr %Frame, ptr %frame, i32 0, i32 2
  %o5 = getelementptr %Frame, ptr %frame, i32 0, i32 3
  %t0 = getelementptr { ptr, ptr, ptr }, ptr %o6, i32 0, i32 2
  store ptr %o3, ptr %t0
  %t1 = getelementptr { ptr, ptr, ptr }, ptr %o6, i32 0, i32 0
  store ptr %o4, ptr %t1
  %t2 = getelementptr { ptr, ptr, ptr }, ptr %o6, i32 0, i32 1
  store ptr %o5, ptr %t2
  ret void
}
...
bb11:
  %t16 = load i64, ptr %s2
  %t17 = add i64 %t16, 16
  %t18 = icmp ule i64 %t17, 64
  br i1 %t18, label %bb12, label %bb13
bb12:
  %t19 = udiv i64 %t16, 16
  %t20 = mul i64 %t19, 1024
  store i64 %t5, ptr %s1
  br label %bb21
bb21:
  %t24 = load i64, ptr %s1
...
bb22:
  ...
  %t30 = sub i64 %hi, %t26
  %t31 = icmp sgt i64 %t30, 64
  %t32 = select i1 %t31, i64 64, i64 %t30
  %t33 = add i64 %t16, 16
...
bb51:
  %t54 = load i64, ptr %s3
  %t55 = icmp uge i64 %t54, 64
  br i1 %t55, label %bb53, label %bb52
bb52:
  %t56 = add i64 %t43, %t54
  %t57 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t56
...
bb60:
  ...
  %t66 = add i64 %t42, %t62
  %t67 = add i64 %t65, %t66
  %t68 = getelementptr [4096 x float], ptr %packed0, i64 0, i64 %t67
...
bb78:
  ...
  %t84 = add i64 %t76, %t80
  %t85 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t84
...
bb133:
  ...
  %t139 = add i64 %t136, 1
  %t140 = icmp ult i64 %t139, 64
  br i1 %t140, label %bb134, label %bb137
bb134:
  %t141 = add i64 %t95, %t136
  %t142 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t141
  %t143 = load float, ptr %t142
  %t144 = add i64 %t97, %t136
  %t145 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t144
  %t146 = load float, ptr %t145
  %t147 = add i64 %t99, %t136
  %t148 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t147
  %t149 = load float, ptr %t148
  %t150 = add i64 %t101, %t136
  %t151 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t150
  %t152 = load float, ptr %t151
  %t153 = add i64 %t95, %t139
  %t154 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t153
  %t155 = load float, ptr %t154
  %t156 = add i64 %t97, %t139
  %t157 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t156
  %t158 = load float, ptr %t157
  %t159 = add i64 %t99, %t139
  %t160 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t159
  %t161 = load float, ptr %t160
  %t162 = add i64 %t101, %t139
  %t163 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t162
  %t164 = load float, ptr %t163
  %t165 = add i64 %t136, 2
  %t166 = mul i64 %t165, 16
  %t167 = add i64 %t20, %t166
  %t168 = getelementptr [4096 x float], ptr %packed0, i64 0, i64 %t167
...
bb170:
  ...
  %t177 = getelementptr [4096 x float], ptr %packed0, i64 0, i64 %t176
  ...
  %t201 = getelementptr [4096 x float], ptr %packed0, i64 0, i64 %t200
...
bb171:
  ...
  br label %bb133
bb137:
  %t224 = icmp ult i64 %t136, 64
  br i1 %t224, label %bb138, label %bb135
bb138:
  %t225 = add i64 %t95, %t136
  %t226 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t225
  %t227 = load float, ptr %t226
  %t228 = add i64 %t97, %t136
  %t229 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t228
  %t230 = load float, ptr %t229
  %t231 = add i64 %t99, %t136
  %t232 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t231
  %t233 = load float, ptr %t232
  %t234 = add i64 %t101, %t136
  %t235 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t234
...
bb238:
  ...
  %t245 = getelementptr [4096 x float], ptr %packed0, i64 0, i64 %t244
...
bb269:
  ...
  %t276 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t275
  store float %t274, ptr %t276
  %t277 = add i64 %t271, 1
  store i64 %t277, ptr %s4
  br label %bb268
bb270:
  %t278 = add i64 %t267, 64
  store i64 0, ptr %s4
  br label %bb279
bb279:
...
bb280:
  ...
  %t288 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t287
  store float %t286, ptr %t288
  %t289 = add i64 %t282, 1
  store i64 %t289, ptr %s4
  br label %bb279
bb281:
  %t290 = add i64 %t267, 128
  store i64 0, ptr %s4
  br label %bb291
bb291:
...
bb292:
  ...
  %t300 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t299
  store float %t298, ptr %t300
  %t301 = add i64 %t294, 1
  store i64 %t301, ptr %s4
  br label %bb291
bb293:
  %t302 = add i64 %t267, 192
  store i64 0, ptr %s4
  br label %bb303
bb303:
...
bb304:
  ...
  %t312 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t311
...
bb344:
  ...
  %t348 = icmp uge i64 %t347, 64
  br i1 %t348, label %bb346, label %bb345
bb345:
  %t349 = add i64 %t336, %t347
  %t350 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t349
...
bb353:
  ...
  %t361 = getelementptr [4096 x float], ptr %packed0, i64 0, i64 %t360
...
bb371:
  ...
  %t378 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t377
...
bb418:
  ...
  %t422 = icmp uge i64 %t421, 64
  br i1 %t422, label %bb420, label %bb419
bb419:
  %t423 = add i64 %t410, %t421
  %t424 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t423
...
bb427:
  ...
  %t435 = getelementptr [4096 x float], ptr %packed0, i64 0, i64 %t434
...
bb445:
  ...
  %t452 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t451
...
bb456:
  %t461 = mul i64 %t458, 64
  %t462 = mul i64 %t458, 64
  %t463 = mul i64 %t458, 64
  %t464 = add i64 64, %t463
  %t465 = mul i64 %t458, 64
  %t466 = add i64 128, %t465
  %t467 = mul i64 %t458, 64
  %t468 = add i64 192, %t467
  store i64 0, ptr %s4
  br label %bb469
bb469:
...
bb500:
  ...
  %t504 = icmp uge i64 %t503, 64
  br i1 %t504, label %bb502, label %bb501
bb501:
  %t505 = add i64 %t462, %t503
  %t506 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t505
  %t507 = load float, ptr %t506
  %t508 = add i64 %t464, %t503
  %t509 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t508
  %t510 = load float, ptr %t509
  %t511 = add i64 %t466, %t503
  %t512 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t511
  %t513 = load float, ptr %t512
  %t514 = add i64 %t468, %t503
  %t515 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t514
...
bb518:
  ...
  %t525 = getelementptr [4096 x float], ptr %packed0, i64 0, i64 %t524
...
bb550:
  ...
  %t557 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t556
  store float %t555, ptr %t557
  %t558 = add i64 %t552, 1
  store i64 %t558, ptr %s4
  br label %bb549
bb551:
  %t559 = add i64 %t548, 64
  store i64 0, ptr %s4
  br label %bb560
bb560:
...
bb561:
  ...
  %t569 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t568
  store float %t567, ptr %t569
  %t570 = add i64 %t563, 1
  store i64 %t570, ptr %s4
  br label %bb560
bb562:
  %t571 = add i64 %t548, 128
  store i64 0, ptr %s4
  br label %bb572
bb572:
...
bb573:
  ...
  %t581 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t580
  store float %t579, ptr %t581
  %t582 = add i64 %t575, 1
  store i64 %t582, ptr %s4
  br label %bb572
bb574:
  %t583 = add i64 %t548, 192
  store i64 0, ptr %s4
  br label %bb584
bb584:
...
bb585:
  ...
  %t593 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t592
...
bb625:
  ...
  %t629 = icmp uge i64 %t628, 64
  br i1 %t629, label %bb627, label %bb626
bb626:
  %t630 = add i64 %t617, %t628
  %t631 = getelementptr [4096 x float], ptr %o4, i64 0, i64 %t630
...
bb634:
  ...
  %t642 = getelementptr [4096 x float], ptr %packed0, i64 0, i64 %t641
...
bb652:
  ...
  %t659 = getelementptr [4096 x float], ptr %o7, i64 0, i64 %t658
...
bb3:
  %t15 = load i64, ptr %s0
  %t16 = icmp uge i64 %t15, 4
  br i1 %t16, label %bb5, label %bb4
bb4:
  %t17 = mul i64 %t15, 16
  %t18 = mul i64 %t15, 1024
  store i64 0, ptr %s1
  br label %bb6
bb6:
  %t19 = load i64, ptr %s1
  %t20 = icmp uge i64 %t19, 64
...
bb10:
  %t25 = add i64 %t17, %t23
  %t26 = add i64 %t22, %t23
  %t27 = getelementptr [4096 x float], ptr %packed0, i64 0, i64 %t26
  %t28 = icmp ult i64 %t25, 64
  br i1 %t28, label %bb12, label %bb13
bb12:
  %t29 = mul i64 %t19, 64
  %t30 = add i64 %t29, %t25
  %t31 = getelementptr [4096 x float], ptr %o5, i64 0, i64 %t30
...
bb5:
  ...
  call void @flow_par_task(ptr %t36, i32 0, i32 1, ptr @task6_slice, i64 4096, i32 4097)
...
entry:
  %frame = alloca %Frame
  %pack0 = alloca [4096 x float], align 64
  %o2 = getelementptr %Frame, ptr %frame, i32 0, i32 0
  %o3 = getelementptr %Frame, ptr %frame, i32 0, i32 1
  %o4 = getelementptr %Frame, ptr %frame, i32 0, i32 2
  %o5 = getelementptr %Frame, ptr %frame, i32 0, i32 3
  ...
  call void @flow_par_task(ptr %h, i32 0, i32 1, ptr @task0, i64 4096, i32 12290)
  call void @flow_par_task(ptr %h, i32 1, i32 0, ptr @task1, i64 6, i32 1)
  call void @flow_par_task(ptr %h, i32 2, i32 1, ptr @task2, i64 4096, i32 8194)
  call void @flow_par_task(ptr %h, i32 3, i32 1, ptr @task3, i64 4096, i32 8194)
  call void @flow_par_task(ptr %h, i32 4, i32 1, ptr @task4, i64 4096, i32 8194)
  call void @flow_par_task(ptr %h, i32 5, i32 0, ptr @task5, i64 3, i32 4098)
  call void @flow_par_task(ptr %h, i32 6, i32 0, ptr @task6, i64 4096, i32 4097)
  call void @flow_par_dep(ptr %h, i32 6, i32 1)
  call void @flow_par_dep(ptr %h, i32 0, i32 3)
  call void @flow_par_dep(ptr %h, i32 0, i32 4)
  call void @flow_par_dep(ptr %h, i32 2, i32 5)
  ...
  call void @flow_par_check(ptr %h, i64 19)
...
define internal float @fn3({ ptr, ptr, i32, i32, float, i32 } %arg) readonly nounwind willreturn {
entry:
  ...
  %t60 = getelementptr [4096 x float], ptr %t56, i64 0, i64 %t59
  ...
  %t66 = getelementptr [4096 x float], ptr %t62, i64 0, i64 %t65
...
define internal float @fn4({ ptr, ptr, i32 } %arg) readonly nounwind willreturn {
entry:
...
bb10:
  %t13 = load i64, ptr %s9
  %t14 = icmp uge i64 %t13, 64
  br i1 %t14, label %bb12, label %bb11
bb11:
  %t15 = trunc i64 %t13 to i32
  %t16 = getelementptr [64 x i32], ptr %o5, i64 0, i64 %t13
...
bb45:
  ...
  %t49 = icmp uge i64 %t48, 64
  br i1 %t49, label %bb47, label %bb46
bb46:
  %t50 = getelementptr [64 x i32], ptr %o5, i64 0, i64 %t48
  ...
  %t67 = call float @fn3({ ptr, ptr, i32, i32, float, i32 } %t66)
