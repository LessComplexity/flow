...
bb89:
  ...
  unreachable
bb90:
  %t91 = getelementptr [4096 x float], ptr %t82, i64 0, i64 %t85
...
bb109:
  ...
  unreachable
bb110:
  %t111 = getelementptr [4096 x float], ptr %t102, i64 0, i64 %t105
...
define internal [4096 x float] @fn1({ ptr, ptr } %arg) {
entry:
  %o0 = alloca { ptr, ptr }
  %o1 = alloca [4096 x float]
  %o2 = alloca ptr
  %o3 = alloca ptr
  %o4 = alloca { [4096 x float], i32 }
  %o5 = alloca { [4096 x float], i32 }
  %o6 = alloca [4096 x float]
  %o7 = alloca i32
  %o8 = alloca { i32, i32 }
  %o9 = alloca i1
  %o10 = alloca { i32, i32 }
  ...
  %o18 = alloca { i32, i32 }
  %o19 = alloca i32
  %o20 = alloca { [4096 x float], i32 }
  %o21 = alloca { { [4096 x float], i32 }, i1 }
  %o22 = alloca { [4096 x float], i1 }
  ...
  %t3 = load ptr, ptr %t2
  store ptr %t3, ptr %o3
  %t4 = getelementptr { [4096 x float], i32 }, ptr %o4, i32 0, i32 1
  store i32 0, ptr %t4
  %t5 = load ptr, ptr %o3
  %t6 = getelementptr { [4096 x float], i32 }, ptr %o4, i32 0, i32 0
  call void @llvm.memcpy.p0.p0.i64(ptr %t6, ptr %t5, i64 ptrtoint (ptr getelementptr ([4096 x float], ptr null, i64 1) to i64), i1 false)
  %t7 = load { [4096 x float], i32 }, ptr %o4
  store { [4096 x float], i32 } %t7, ptr %o5
  br label %bb8
bb8:
  %t12 = getelementptr { i32, i32 }, ptr %o8, i32 0, i32 1
  store i32 4096, ptr %t12
  %t13 = getelementptr { [4096 x float], i32 }, ptr %o5, i32 0, i32 0
  call void @llvm.memcpy.p0.p0.i64(ptr %o6, ptr %t13, i64 ptrtoint (ptr getelementptr ([4096 x float], ptr null, i64 1) to i64), i1 false)
  %t14 = getelementptr { [4096 x float], i32 }, ptr %o5, i32 0, i32 1
  %t15 = load i32, ptr %t14
  store i32 %t15, ptr %o7
  %t16 = getelementptr { [4096 x float], i1 }, ptr %o22, i32 0, i32 0
  call void @llvm.memcpy.p0.p0.i64(ptr %t16, ptr %o6, i64 ptrtoint (ptr getelementptr ([4096 x float], ptr null, i64 1) to i64), i1 false)
  %t17 = load i32, ptr %o7
  ...
  store i1 %t23, ptr %o9
  %t24 = load i1, ptr %o9
  %t25 = getelementptr { [4096 x float], i1 }, ptr %o22, i32 0, i32 1
  store i1 %t24, ptr %t25
  %t26 = getelementptr { [4096 x float], i1 }, ptr %o22, i32 0, i32 1
  %t27 = load i1, ptr %t26
  br i1 %t27, label %bb9, label %bb10
bb9:
  %t28 = getelementptr { i32, i32 }, ptr %o10, i32 0, i32 1
  store i32 64, ptr %t28
  %t29 = getelementptr { i32, i32 }, ptr %o12, i32 0, i32 1
  store i32 64, ptr %t29
  ...
  %t59 = load i1, ptr %o9
  %t60 = getelementptr { { [4096 x float], i32 }, i1 }, ptr %o21, i32 0, i32 1
  ...
  %t66 = getelementptr { [4096 x float], i32 }, ptr %o20, i32 0, i32 1
...
bb88:
  ...
  unreachable
bb89:
  %t90 = getelementptr [4096 x float], ptr %o6, i64 0, i64 %t84
  %t91 = getelementptr { ptr, i32, float }, ptr %o16, i32 0, i32 2
  %t92 = load float, ptr %t91
  store float %t92, ptr %t90
  %t93 = getelementptr { [4096 x float], i32 }, ptr %o20, i32 0, i32 0
  call void @llvm.memcpy.p0.p0.i64(ptr %t93, ptr %o6, i64 ptrtoint (ptr getelementptr ([4096 x float], ptr null, i64 1) to i64), i1 false)
  %t94 = load { [4096 x float], i32 }, ptr %o20
  %t95 = getelementptr { { [4096 x float], i32 }, i1 }, ptr %o21, i32 0, i32 0
  store { [4096 x float], i32 } %t94, ptr %t95
  %t96 = getelementptr { { [4096 x float], i32 }, i1 }, ptr %o21, i32 0, i32 0
  %t97 = load { [4096 x float], i32 }, ptr %t96
  store { [4096 x float], i32 } %t97, ptr %o5
  br label %bb8
bb10:
  call void @llvm.memcpy.p0.p0.i64(ptr %o1, ptr %o6, i64 ptrtoint (ptr getelementptr ([4096 x float], ptr null, i64 1) to i64), i1 false)
  br label %bb11
bb11:
  %t98 = load [4096 x float], ptr %o1
  ret [4096 x float] %t98
}

%Frame = type { [4096 x i32], [4096 x float], [4096 x float], { ptr, ptr }, [4096 x float], { ptr, i32 }, float, float, { ptr, i32 }, float, float }
...
entry:
  ...
  %t8 = call [4096 x float] @fn1({ ptr, ptr } %t7)
  store [4096 x float] %t8, ptr %o6
  ...
  %t14 = getelementptr [4096 x float], ptr %o6, i64 0, i64 %t13
  ...
  %t19 = getelementptr [4096 x float], ptr %o6, i64 0, i64 %t18
...
bb2:
  ...
  %t9 = getelementptr [4096 x float], ptr %o3, i64 0, i64 %t4
...
entry:
  ...
  call void @flow_par_task(ptr %h, i32 0, i32 1, ptr @task0, i64 4096, i32 8193)
  call void @flow_par_task(ptr %h, i32 1, i32 0, ptr @task1, i64 9, i32 1)
  call void @flow_par_task(ptr %h, i32 2, i32 1, ptr @task2, i64 4096, i32 4097)
  call void @flow_par_task(ptr %h, i32 3, i32 1, ptr @task3, i64 4096, i32 4097)
