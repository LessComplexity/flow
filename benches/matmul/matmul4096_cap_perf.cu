...
static __host__ __device__ double fn1(int32_t in) {
  double o1;
  o1 = (double)(((int32_t)((uint32_t)(((int32_t)((uint32_t)((int32_t)((uint32_t)in * (uint32_t)7)) + (uint32_t)13)) % 101) - (uint32_t)50)));
  return o1;
}
static __host__ __device__ double fn2(int32_t in) {
  double o1;
  o1 = (double)(((int32_t)((uint32_t)(((int32_t)((uint32_t)((int32_t)((uint32_t)in * (uint32_t)7)) + (uint32_t)57)) % 101) - (uint32_t)50)));
  return o1;
}
static __device__ double d_fn3(FlowProd_doublep_int32_t_doublep_int32_t_double_int32_t in) {
  double o1;
  ...
  o4 = in.f2;
  o7 = in.f5;
  int64_t t0 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)in.f1 * (uint32_t)4096)) + (uint32_t)o7));
  int64_t t1 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)o7 * (uint32_t)4096)) + (uint32_t)in.f3));
...
static __device__ double d_fn4(FlowProd_int32_tp_doublep_doublep_int32_t in) {
  ...
  double* o4;
  int32_t o5;
  FlowProd_doublep_int32_t_doublep_int32_t_double_int32_tp o10;
  o2 = in.f0;
  o3 = in.f1;
  o4 = in.f2;
  o5 = in.f3;
  ...
  pair.f2 = o10.f2;
  pair.f3 = o10.f3;
  for (unsigned long long t1 = 0; t1 < 4096ULL; t1++) {
    pair.f4 = t0;
    pair.f5 = o2[t1];
    t0 = d_fn3(pair);
  }
...
static void flow_main() {
  ...
  double* t0 = nullptr;
  double* t1 = nullptr;
  cu_check(cudaMalloc((void**)&arena0, 469778944ULL), "cudaMalloc(arena0)");
  ...
  k0_0<<<(unsigned int)((16777216ULL + 255ULL) / 256ULL), 256>>>(o2, 16777216);
  ...
  o3 = (int32_t*)(arena0 + 67108864ULL);
  cu_check(cudaEventRecord(fev1_start), "cudaEventRecord");
  k0_0<<<(unsigned int)((4096ULL + 255ULL) / 256ULL), 256>>>(o3, 4096);
  ...
  flow_perf_total += flow_perf_ms;
  printf("FLOW_PERF launch=k0_0 ms=%.4f\n", flow_perf_ms);
  o4 = (double*)(arena0 + 67125248ULL);
  cu_check(cudaEventRecord(fev2_start), "cudaEventRecord");
  k0_2<<<(unsigned int)((16777216ULL + 255ULL) / 256ULL), 256>>>(o4, o2);
  ...
  o5 = (double*)(arena0 + 201342976ULL);
  cu_check(cudaEventRecord(fev3_start), "cudaEventRecord");
  k0_3<<<(unsigned int)((16777216ULL + 255ULL) / 256ULL), 256>>>(o5, o2);
  ...
  o6.f1 = o4;
  o6.f2 = o5;
  o7 = (double*)(arena0 + 335560704ULL);
  cu_check(cudaEventRecord(fev4_start), "cudaEventRecord");
  k0_4<<<(unsigned int)((16777216ULL + 255ULL) / 256ULL), 256>>>(o7, o2, o3, o4, o5);
  ...
  t1 = (double*)(arena0 + 469778688ULL);
  cu_check(cudaEventRecord(fev6_start), "cudaEventRecord");
  k0_5<<<1, 1>>>(t1, o7, (int64_t)16777215);
  ...
  flow_perf_total += flow_perf_ms;
  printf("FLOW_PERF launch=k0_5 ms=%.4f\n", flow_perf_ms);
  cu_check(cudaMemcpy(&o11, t1, sizeof(double), cudaMemcpyDeviceToHost), "cudaMemcpy(index)");
  o12 = o9;
  o14 = o11;
  flow_print_f64(o12, true);
