...
entry:
  ...
  %o3 = alloca [4096 x double]
  %o4 = alloca [4096 x double]
  %o5 = alloca [64 x i32]
  %o6 = alloca { ptr, ptr, ptr, ptr }
  %o7 = alloca [4096 x double]
  %o8 = alloca { ptr, i32 }
  %o9 = alloca double
  %o10 = alloca double
  %o12 = alloca { ptr, i32 }
...
bb12:
  ...
  store i32 4095, ptr %t19
  store i64 0, ptr %s20
  br label %bb21
bb21:
  %t24 = load i64, ptr %s20
  %t25 = icmp uge i64 %t24, 4096
  br i1 %t25, label %bb23, label %bb22
bb22:
  %t26 = getelementptr [4096 x i32], ptr %o2, i64 0, i64 %t24
  %t27 = load i32, ptr %t26
  %t28 = call double @fn1(i32 %t27)
  %t29 = getelementptr [4096 x double], ptr %o3, i64 0, i64 %t24
...
bb32:
  ...
  %t36 = icmp uge i64 %t35, 4096
  br i1 %t36, label %bb34, label %bb33
bb33:
  %t37 = getelementptr [4096 x i32], ptr %o2, i64 0, i64 %t35
  %t38 = load i32, ptr %t37
  %t39 = call double @fn2(i32 %t38)
  %t40 = getelementptr [4096 x double], ptr %o4, i64 0, i64 %t35
...
bb47:
  ...
  %t51 = icmp uge i64 %t50, 4096
  br i1 %t51, label %bb49, label %bb48
bb48:
  %t52 = getelementptr [4096 x i32], ptr %o2, i64 0, i64 %t50
  ...
  %t61 = getelementptr [4096 x double], ptr %o7, i64 0, i64 %t50
...
bb49:
  ...
  %t68 = getelementptr [4096 x double], ptr %o7, i64 0, i64 %t67
  ...
  %t73 = getelementptr [4096 x double], ptr %o7, i64 0, i64 %t72
...
entry:
  ...
  store i32 64, ptr %t9
  %t10 = getelementptr { double, [64 x i32] }, ptr %o10, i32 0, i32 0
  store double 0x0000000000000000, ptr %t10
  %t11 = load ptr, ptr %o2
  %t12 = getelementptr { double, [64 x i32] }, ptr %o10, i32 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr %t12, ptr %t11, i64 ptrtoint (ptr getelementptr ([64 x i32], ptr null, i64 1) to i64), i1 false)
  %t13 = load ptr, ptr %o3
  ...
  %t21 = getelementptr { double, [64 x i32] }, ptr %o10, i32 0, i32 0
  %t22 = load double, ptr %t21
  store double %t22, ptr %o11
  %t23 = load ptr, ptr %o2
  call void @llvm.memcpy.p0.p0.i64(ptr %o12, ptr %t23, i64 ptrtoint (ptr getelementptr ([64 x i32], ptr null, i64 1) to i64), i1 false)
...
bb46:
  %t50 = getelementptr [64 x i32], ptr %o12, i64 0, i64 %t48
