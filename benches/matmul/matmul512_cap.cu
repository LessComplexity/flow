...
static __device__ double d_fn3(FlowProd_doublep_int32_t_doublep_int32_t_double_int32_t in) {
  ...
  o4 = in.f2;
  o7 = in.f5;
  int64_t t0 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)in.f1 * (uint32_t)512)) + (uint32_t)o7));
  int64_t t1 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)o7 * (uint32_t)512)) + (uint32_t)in.f3));
...
static void flow_main() {
  ...
  double* t0 = nullptr;
  double* t1 = nullptr;
  cu_check(cudaMalloc((void**)&arena0, 7342592ULL), "cudaMalloc(arena0)");
  o2 = (int32_t*)(arena0 + 0ULL);
  k0_0<<<(unsigned int)((262144ULL + 255ULL) / 256ULL), 256>>>(o2, 262144);
  o3 = (int32_t*)(arena0 + 1048576ULL);
  k0_0<<<(unsigned int)((512ULL + 255ULL) / 256ULL), 256>>>(o3, 512);
  o4 = (double*)(arena0 + 1050624ULL);
  k0_2<<<(unsigned int)((262144ULL + 255ULL) / 256ULL), 256>>>(o4, o2);
  o5 = (double*)(arena0 + 3147776ULL);
  k0_3<<<(unsigned int)((262144ULL + 255ULL) / 256ULL), 256>>>(o5, o2);
  o6.f3 = o2;
  o6.f0 = o3;
  o6.f1 = o4;
  o6.f2 = o5;
  o7 = (double*)(arena0 + 5244928ULL);
  k0_4<<<(unsigned int)((262144ULL + 255ULL) / 256ULL), 256>>>(o7, o2, o3, o4, o5);
  t0 = (double*)(arena0 + 7342080ULL);
  k0_5<<<1, 1>>>(t0, o7, (int64_t)0);
  cu_check(cudaMemcpy(&o9, t0, sizeof(double), cudaMemcpyDeviceToHost), "cudaMemcpy(index)");
  t1 = (double*)(arena0 + 7342336ULL);
