...
static void flow_main() {
  ...
  double* t0 = nullptr;
  double* t1 = nullptr;
  cu_check(cudaMalloc((void**)&arena0, 29364736ULL), "cudaMalloc(arena0)");
