...
static __device__ double d_fn3(FlowProd_doublep_int32_t_doublep_int32_t_double_int32_t in) {
  ...
  o4 = in.f2;
  o7 = in.f5;
  int64_t t0 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)in.f1 * (uint32_t)128)) + (uint32_t)o7));
...
static void flow_main() {
  ...
  k0_0<<<(unsigned int)((128ULL + 255ULL) / 256ULL), 256>>>(o3, 128);
  o4 = (double*)(arena0 + 66048ULL);
  k0_2<<<(unsigned int)((16384ULL + 255ULL) / 256ULL), 256>>>(o4, o2);
  o5 = (double*)(arena0 + 197120ULL);
  ...
  k0_4<<<(unsigned int)((16384ULL + 255ULL) / 256ULL), 256>>>(o7, o2, o3, o4, o5);
