...
static __device__ double d_fn3(FlowProd_doublep_int32_t_doublep_int32_t_double_int32_t in) {
  ...
  o4 = in.f2;
  o7 = in.f5;
  int64_t t0 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)in.f1 * (uint32_t)64)) + (uint32_t)o7));
  int64_t t1 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)o7 * (uint32_t)64)) + (uint32_t)in.f3));
...
static void flow_main() {
  ...
  double* t0 = nullptr;
  double* t1 = nullptr;
  cu_check(cudaMalloc((void**)&arena0, 115456ULL), "cudaMalloc(arena0)");
  ...
  o3 = (int32_t*)(arena0 + 16384ULL);
  cu_check(cudaEventRecord(fev1_start), "cudaEventRecord");
  k0_0<<<(unsigned int)((64ULL + 255ULL) / 256ULL), 256>>>(o3, 64);
  ...
  flow_perf_total += flow_perf_ms;
  printf("FLOW_PERF launch=k0_0 ms=%.4f\n", flow_perf_ms);
  o4 = (double*)(arena0 + 16640ULL);
  cu_check(cudaEventRecord(fev2_start), "cudaEventRecord");
  k0_2<<<(unsigned int)((4096ULL + 255ULL) / 256ULL), 256>>>(o4, o2);
  ...
  o5 = (double*)(arena0 + 49408ULL);
  cu_check(cudaEventRecord(fev3_start), "cudaEventRecord");
  k0_3<<<(unsigned int)((4096ULL + 255ULL) / 256ULL), 256>>>(o5, o2);
  ...
  o6.f1 = o4;
  o6.f2 = o5;
  o7 = (double*)(arena0 + 82176ULL);
  cu_check(cudaEventRecord(fev4_start), "cudaEventRecord");
  k0_4<<<(unsigned int)((4096ULL + 255ULL) / 256ULL), 256>>>(o7, o2, o3, o4, o5);
