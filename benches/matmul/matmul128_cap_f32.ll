...
bb22:
  ...
  %t29 = getelementptr [16384 x float], ptr %o3, i64 0, i64 %t24
...
bb33:
  ...
  %t40 = getelementptr [16384 x float], ptr %o4, i64 0, i64 %t35
...
entry:
  ...
  %t10 = getelementptr { float, [128 x i32] }, ptr %o10, i32 0, i32 0
  store float 0x0000000000000000, ptr %t10
  %t11 = load ptr, ptr %o2
  %t12 = getelementptr { float, [128 x i32] }, ptr %o10, i32 0, i32 1
  ...
  %t21 = getelementptr { float, [128 x i32] }, ptr %o10, i32 0, i32 0
