...
%Frame = type { [16 x i32], [4 x i32], [16 x double], [16 x double], { ptr, ptr, ptr, ptr }, [16 x double], { ptr, i32 }, double, { ptr, i32 }, double, double, double }
...
bb12:
  ...
  %t20 = sub i64 %hi, %t16
  %t21 = icmp sgt i64 %t20, 4
  %t22 = select i1 %t21, i64 4, i64 %t20
  %t23 = mul i64 %t14, 4
...
bb39:
  %t45 = load i64, ptr %s3
  %t46 = icmp uge i64 %t45, 4
  br i1 %t46, label %bb41, label %bb40
bb40:
  %t47 = add i64 %t23, %t45
  %t48 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t47
...
bb43:
  %t54 = add i64 %t51, %t52
  %t55 = getelementptr [16 x double], ptr %o5, i64 0, i64 %t54
...
bb65:
  ...
  %t71 = add i64 %t63, %t67
  %t72 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t71
...
bb86:
  %t92 = load i64, ptr %s3
  %t93 = icmp uge i64 %t92, 4
  br i1 %t93, label %bb88, label %bb87
bb87:
  %t94 = add i64 %t23, %t92
  %t95 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t94
...
bb90:
  ...
  %t102 = getelementptr [16 x double], ptr %o5, i64 0, i64 %t101
...
bb112:
  ...
  %t119 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t118
...
bb123:
  ...
  %t133 = add i64 8, %t132
  %t134 = mul i64 %t125, 4
  %t135 = add i64 12, %t134
  store i64 0, ptr %s2
  br label %bb136
bb136:
  %t141 = load i64, ptr %s2
  %t142 = add i64 %t141, 16
  %t143 = icmp ule i64 %t142, 4
...
bb175:
  ...
  %t182 = icmp uge i64 %t181, 4
  br i1 %t182, label %bb177, label %bb176
bb176:
  %t183 = add i64 %t129, %t181
  %t184 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t183
  %t185 = load double, ptr %t184
  %t186 = add i64 %t131, %t181
  %t187 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t186
  %t188 = load double, ptr %t187
  %t189 = add i64 %t133, %t181
  %t190 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t189
  %t191 = load double, ptr %t190
  %t192 = add i64 %t135, %t181
  %t193 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t192
...
bb179:
  ...
  %t200 = getelementptr [16 x double], ptr %o5, i64 0, i64 %t199
...
bb225:
  ...
  %t232 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t231
...
bb236:
  ...
  %t244 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t243
...
bb248:
  ...
  %t256 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t255
  store double %t254, ptr %t256
  %t257 = add i64 %t250, 1
  store i64 %t257, ptr %s4
  br label %bb247
bb249:
  %t258 = add i64 %t223, 12
  store i64 0, ptr %s4
  br label %bb259
bb259:
...
bb260:
  ...
  %t268 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t267
...
bb306:
  ...
  %t313 = icmp uge i64 %t312, 4
  br i1 %t313, label %bb308, label %bb307
bb307:
  %t314 = add i64 %t129, %t312
  %t315 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t314
  %t316 = load double, ptr %t315
  %t317 = add i64 %t131, %t312
  %t318 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t317
  %t319 = load double, ptr %t318
  %t320 = add i64 %t133, %t312
  %t321 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t320
  %t322 = load double, ptr %t321
  %t323 = add i64 %t135, %t312
  %t324 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t323
...
bb310:
  ...
  %t331 = getelementptr [16 x double], ptr %o5, i64 0, i64 %t330
...
bb356:
  ...
  %t363 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t362
...
bb367:
  ...
  %t375 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t374
...
bb379:
  ...
  %t387 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t386
  store double %t385, ptr %t387
  %t388 = add i64 %t381, 1
  store i64 %t388, ptr %s4
  br label %bb378
bb380:
  %t389 = add i64 %t354, 12
  store i64 0, ptr %s4
  br label %bb390
bb390:
...
bb391:
  ...
  %t399 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t398
...
bb402:
  ...
  %t411 = icmp sgt i64 %t410, 4
  %t412 = select i1 %t411, i64 4, i64 %t410
  %t413 = mul i64 %t404, 4
...
bb429:
  ...
  %t436 = icmp uge i64 %t435, 4
  br i1 %t436, label %bb431, label %bb430
bb430:
  %t437 = add i64 %t413, %t435
  %t438 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t437
...
bb433:
  ...
  %t445 = getelementptr [16 x double], ptr %o5, i64 0, i64 %t444
...
bb455:
  ...
  %t462 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t461
...
bb476:
  ...
  %t483 = icmp uge i64 %t482, 4
  br i1 %t483, label %bb478, label %bb477
bb477:
  %t484 = add i64 %t413, %t482
  %t485 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t484
...
bb480:
  ...
  %t492 = getelementptr [16 x double], ptr %o5, i64 0, i64 %t491
...
bb502:
  ...
  %t509 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t508
...
entry:
  ...
  call void @flow_par_task(ptr %h, i32 6, i32 1, ptr @task6, i64 16, i32 17)
