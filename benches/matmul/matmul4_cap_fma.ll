...
%Frame = type { [16 x i32], [4 x i32], [16 x double], [16 x double], { ptr, ptr, ptr, ptr }, [16 x double], { ptr, i32 }, double, { ptr, i32 }, double, double, double, ptr }
...
bb2:
  ...
  %t7 = getelementptr [16 x i32], ptr %o2, i64 0, i64 %t4
  store i32 %t6, ptr %t7
  %t8 = add i64 %t4, 1
  store i64 %t8, ptr %s0
  br label %bb1
...
bb2:
  %t6 = trunc i64 %t4 to i32
  %t7 = getelementptr [4 x i32], ptr %o3, i64 0, i64 %t4
  store i32 %t6, ptr %t7
  %t8 = add i64 %t4, 1
  store i64 %t8, ptr %s0
  br label %bb1
...
bb1:
  ...
  br i1 %t5, label %bb3, label %bb2
bb2:
  %t6 = getelementptr [16 x i32], ptr %o2, i64 0, i64 %t4
  %t7 = load i32, ptr %t6
  %t8 = call double @fn1(i32 %t7)
  %t9 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t4
...
bb2:
  ...
  %t9 = getelementptr [16 x double], ptr %o5, i64 0, i64 %t4
  store double %t8, ptr %t9
  %t10 = add i64 %t4, 1
  store i64 %t10, ptr %s0
  br label %bb1
...
bb52:
  %t56 = add i64 %t43, %t54
  %t57 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t56
...
bb60:
  ...
  %t66 = add i64 %t42, %t62
  %t67 = add i64 %t65, %t66
  %t68 = getelementptr [32 x double], ptr %packed0, i64 0, i64 %t67
...
bb78:
  ...
  %t84 = add i64 %t76, %t80
  %t85 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t84
...
bb134:
  ...
  %t142 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t141
  %t143 = load double, ptr %t142
  %t144 = add i64 %t97, %t136
  %t145 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t144
  %t146 = load double, ptr %t145
  %t147 = add i64 %t99, %t136
  %t148 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t147
  %t149 = load double, ptr %t148
  %t150 = add i64 %t101, %t136
  %t151 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t150
  %t152 = load double, ptr %t151
  %t153 = add i64 %t95, %t139
  %t154 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t153
  %t155 = load double, ptr %t154
  %t156 = add i64 %t97, %t139
  %t157 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t156
  %t158 = load double, ptr %t157
  %t159 = add i64 %t99, %t139
  %t160 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t159
  %t161 = load double, ptr %t160
  %t162 = add i64 %t101, %t139
  %t163 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t162
  %t164 = load double, ptr %t163
  %t165 = add i64 %t136, 2
  %t166 = mul i64 %t165, 8
  %t167 = add i64 %t20, %t166
  %t168 = getelementptr [32 x double], ptr %packed0, i64 0, i64 %t167
...
bb170:
  ...
  %t177 = getelementptr [32 x double], ptr %packed0, i64 0, i64 %t176
  ...
  %t201 = getelementptr [32 x double], ptr %packed0, i64 0, i64 %t200
...
bb138:
  ...
  %t226 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t225
  %t227 = load double, ptr %t226
  %t228 = add i64 %t97, %t136
  %t229 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t228
  %t230 = load double, ptr %t229
  %t231 = add i64 %t99, %t136
  %t232 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t231
  %t233 = load double, ptr %t232
  %t234 = add i64 %t101, %t136
  %t235 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t234
...
bb238:
  ...
  %t245 = getelementptr [32 x double], ptr %packed0, i64 0, i64 %t244
...
bb269:
  ...
  %t276 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t275
...
bb280:
  ...
  %t288 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t287
...
bb292:
  ...
  %t300 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t299
...
bb304:
  ...
  %t312 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t311
...
bb345:
  ...
  %t350 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t349
...
bb353:
  ...
  %t361 = getelementptr [32 x double], ptr %packed0, i64 0, i64 %t360
...
bb371:
  ...
  %t378 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t377
...
bb419:
  ...
  %t424 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t423
...
bb427:
  ...
  %t435 = getelementptr [32 x double], ptr %packed0, i64 0, i64 %t434
...
bb445:
  ...
  %t452 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t451
...
bb501:
  ...
  %t506 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t505
  %t507 = load double, ptr %t506
  %t508 = add i64 %t464, %t503
  %t509 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t508
  %t510 = load double, ptr %t509
  %t511 = add i64 %t466, %t503
  %t512 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t511
  %t513 = load double, ptr %t512
  %t514 = add i64 %t468, %t503
  %t515 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t514
...
bb518:
  ...
  %t525 = getelementptr [32 x double], ptr %packed0, i64 0, i64 %t524
...
bb550:
  ...
  %t557 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t556
...
bb561:
  ...
  %t569 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t568
...
bb573:
  ...
  %t581 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t580
...
bb585:
  ...
  %t593 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t592
...
bb626:
  ...
  %t631 = getelementptr [16 x double], ptr %o4, i64 0, i64 %t630
...
bb634:
  ...
  %t642 = getelementptr [32 x double], ptr %packed0, i64 0, i64 %t641
...
bb652:
  ...
  %t659 = getelementptr [16 x double], ptr %o7, i64 0, i64 %t658
...
bb10:
  %t25 = add i64 %t17, %t23
  %t26 = add i64 %t22, %t23
  %t27 = getelementptr [32 x double], ptr %packed0, i64 0, i64 %t26
  %t28 = icmp ult i64 %t25, 4
  br i1 %t28, label %bb12, label %bb13
bb12:
  %t29 = mul i64 %t19, 4
  %t30 = add i64 %t29, %t25
  %t31 = getelementptr [16 x double], ptr %o5, i64 0, i64 %t30
...
bb5:
  ...
  call void @flow_par_task(ptr %t36, i32 0, i32 1, ptr @task6_slice, i64 16, i32 17)
...
entry:
  %frame = alloca %Frame
  %pack0 = alloca [32 x double], align 64
  %o2 = getelementptr %Frame, ptr %frame, i32 0, i32 0
  %o3 = getelementptr %Frame, ptr %frame, i32 0, i32 1
  %o4 = getelementptr %Frame, ptr %frame, i32 0, i32 2
  %o5 = getelementptr %Frame, ptr %frame, i32 0, i32 3
  ...
  call void @flow_par_task(ptr %h, i32 0, i32 1, ptr @task0, i64 16, i32 50)
  call void @flow_par_task(ptr %h, i32 1, i32 1, ptr @task1, i64 4, i32 22)
  call void @flow_par_task(ptr %h, i32 2, i32 0, ptr @task2, i64 6, i32 1)
  call void @flow_par_task(ptr %h, i32 3, i32 1, ptr @task3, i64 16, i32 34)
  call void @flow_par_task(ptr %h, i32 4, i32 1, ptr @task4, i64 16, i32 34)
  call void @flow_par_task(ptr %h, i32 5, i32 0, ptr @task5, i64 4, i32 18)
  call void @flow_par_task(ptr %h, i32 6, i32 0, ptr @task6, i64 16, i32 17)
...
entry:
  ...
  %t60 = getelementptr [16 x double], ptr %t56, i64 0, i64 %t59
  ...
  %t66 = getelementptr [16 x double], ptr %t62, i64 0, i64 %t65
...
bb40:
  ...
  %t44 = icmp uge i64 %t43, 4
  br i1 %t44, label %bb42, label %bb41
bb41:
  %t45 = getelementptr [4 x i32], ptr %t37, i64 0, i64 %t43
