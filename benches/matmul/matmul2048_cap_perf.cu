...
static __device__ double d_fn3(FlowProd_doublep_int32_t_doublep_int32_t_double_int32_t in) {
  ...
  o4 = in.f2;
  o7 = in.f5;
  int64_t t0 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)in.f1 * (uint32_t)2048)) + (uint32_t)o7));
  int64_t t1 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)o7 * (uint32_t)2048)) + (uint32_t)in.f3));
...
static __device__ double d_fn4(FlowProd_int32_tp_doublep_doublep_int32_t in) {
  ...
  pair.f2 = o10.f2;
  pair.f3 = o10.f3;
  for (unsigned long long t1 = 0; t1 < 2048ULL; t1++) {
    pair.f4 = t0;
    pair.f5 = o2[t1];
    t0 = d_fn3(pair);
  }
...
static void flow_main() {
  ...
  double* t0 = nullptr;
  double* t1 = nullptr;
  cu_check(cudaMalloc((void**)&arena0, 117449216ULL), "cudaMalloc(arena0)");
  ...
  k0_0<<<(unsigned int)((4194304ULL + 255ULL) / 256ULL), 256>>>(o2, 4194304);
  ...
  o3 = (int32_t*)(arena0 + 16777216ULL);
  cu_check(cudaEventRecord(fev1_start), "cudaEventRecord");
  k0_0<<<(unsigned int)((2048ULL + 255ULL) / 256ULL), 256>>>(o3, 2048);
  ...
  flow_perf_total += flow_perf_ms;
  printf("FLOW_PERF launch=k0_0 ms=%.4f\n", flow_perf_ms);
  o4 = (double*)(arena0 + 16785408ULL);
  cu_check(cudaEventRecord(fev2_start), "cudaEventRecord");
  k0_2<<<(unsigned int)((4194304ULL + 255ULL) / 256ULL), 256>>>(o4, o2);
  ...
  o5 = (double*)(arena0 + 50339840ULL);
  cu_check(cudaEventRecord(fev3_start), "cudaEventRecord");
  k0_3<<<(unsigned int)((4194304ULL + 255ULL) / 256ULL), 256>>>(o5, o2);
  ...
  o6.f1 = o4;
  o6.f2 = o5;
  o7 = (double*)(arena0 + 83894272ULL);
  cu_check(cudaEventRecord(fev4_start), "cudaEventRecord");
  k0_4<<<(unsigned int)((4194304ULL + 255ULL) / 256ULL), 256>>>(o7, o2, o3, o4, o5);
  ...
  t1 = (double*)(arena0 + 117448960ULL);
  cu_check(cudaEventRecord(fev6_start), "cudaEventRecord");
  k0_5<<<1, 1>>>(t1, o7, (int64_t)4194303);
