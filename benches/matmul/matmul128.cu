...
static __device__ float d_fn3(FlowProd_floatp_floatp_int32_t_int32_t_float_int32_t in) {
  ...
  o3 = in.f1;
  o7 = in.f5;
  int64_t t0 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)in.f2 * (uint32_t)128)) + (uint32_t)o7));
  int64_t t1 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)o7 * (uint32_t)128)) + (uint32_t)in.f3));
...
static __device__ float d_fn4(FlowProd_floatp_floatp_int32_t in) {
  ...
  o4 = in.f2;
  o10.f4 = 0e0f;
  for (unsigned long long t0 = 0; t0 < 128ULL; t0++) {
    o5[t0] = (int32_t)t0;
  }
  o10.f0 = o2;
  o10.f1 = o3;
  ...
  pair.f2 = o10.f2;
  pair.f3 = o10.f3;
  for (unsigned long long t2 = 0; t2 < 128ULL; t2++) {
    pair.f4 = t1;
    pair.f5 = o5[t2];
    t1 = d_fn3(pair);
  }
...
static void flow_main() {
  ...
  float* t0 = nullptr;
  float* t1 = nullptr;
  cu_check(cudaMalloc((void**)&arena0, 328192ULL), "cudaMalloc(arena0)");
  o2 = (int32_t*)(arena0 + 0ULL);
  k0_0<<<(unsigned int)((16384ULL + 255ULL) / 256ULL), 256>>>(o2, 16384);
  o3 = (int32_t*)(arena0 + 65536ULL);
  k0_0<<<(unsigned int)((16384ULL + 255ULL) / 256ULL), 256>>>(o3, 16384);
  o4 = (float*)(arena0 + 131072ULL);
  k0_2<<<(unsigned int)((16384ULL + 255ULL) / 256ULL), 256>>>(o4, o2);
  o5 = (float*)(arena0 + 196608ULL);
  k0_3<<<(unsigned int)((16384ULL + 255ULL) / 256ULL), 256>>>(o5, o2);
  o6.f2 = o3;
  o6.f0 = o4;
  o6.f1 = o5;
  o7 = (float*)(arena0 + 262144ULL);
  k0_4<<<(unsigned int)((16384ULL + 255ULL) / 256ULL), 256>>>(o7, o3, o4, o5);
  t0 = (float*)(arena0 + 327680ULL);
  k0_5<<<1, 1>>>(t0, o7, (int64_t)0);
  cu_check(cudaMemcpy(&o9, t0, sizeof(float), cudaMemcpyDeviceToHost), "cudaMemcpy(index)");
  t1 = (float*)(arena0 + 327936ULL);
