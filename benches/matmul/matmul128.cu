...
__global__ void k0_0(float* result, float* arr, int64_t idx, unsigned int* trap) {
  if (idx < 0 || idx >= (int64_t)16384) { *trap = 2u; return; }
...
static float* fn1(FlowProd_floatp_floatp in) {
  ...
  while (true) {
    ...
    o15 = fn0(o14);
    o16.f2 = o15;
    cu_check(cudaMalloc((void**)&o17, sizeof(float) * 16384ULL), "cudaMalloc(o17)");
    k1_0<<<(unsigned int)((16384ULL + 255ULL) / 256ULL), 256>>>(o17, o6, (int64_t)o7, o15, d_trap);
    trap_check_after_launch();
    o20.f0 = o17;
    o21.f0 = o20;
    o5 = o21.f0;
...
static void flow_main() {
  ...
  k2_2<<<(unsigned int)((16384ULL + 255ULL) / 256ULL), 256>>>(o4, o2);
  o5.f0 = o3;
  o5.f1 = o4;
  o6 = fn1(o5);
  ...
  t1 = (float*)(arena0 + 196864ULL);
  k2_3<<<1, 1>>>(t1, o6, (int64_t)16383);
