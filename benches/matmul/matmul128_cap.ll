...
entry:
  ...
  %o3 = alloca [16384 x double]
  %o4 = alloca [16384 x double]
  %o5 = alloca [128 x i32]
  %o6 = alloca { ptr, ptr, ptr, ptr }
  %o7 = alloca [16384 x double]
  %o8 = alloca { ptr, i32 }
  %o9 = alloca double
  %o10 = alloca double
  %o12 = alloca { ptr, i32 }
...
bb22:
  ...
  %t29 = getelementptr [16384 x double], ptr %o3, i64 0, i64 %t24
...
bb33:
  ...
  %t40 = getelementptr [16384 x double], ptr %o4, i64 0, i64 %t35
...
bb48:
  ...
  %t61 = getelementptr [16384 x double], ptr %o7, i64 0, i64 %t50
...
bb49:
  ...
  %t68 = getelementptr [16384 x double], ptr %o7, i64 0, i64 %t67
  ...
  %t73 = getelementptr [16384 x double], ptr %o7, i64 0, i64 %t72
...
entry:
  ...
  %o8 = alloca { i32, i32 }
  %o9 = alloca i32
  %o10 = alloca { double, [128 x i32] }
  %o11 = alloca double
  %o12 = alloca [128 x i32]
  ...
  %t10 = getelementptr { double, [128 x i32] }, ptr %o10, i32 0, i32 0
  store double 0x0000000000000000, ptr %t10
  %t11 = load ptr, ptr %o2
  %t12 = getelementptr { double, [128 x i32] }, ptr %o10, i32 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr %t12, ptr %t11, i64 ptrtoint (ptr getelementptr ([128 x i32], ptr null, i64 1) to i64), i1 false)
  %t13 = load ptr, ptr %o3
  ...
  %t21 = getelementptr { double, [128 x i32] }, ptr %o10, i32 0, i32 0
  %t22 = load double, ptr %t21
  store double %t22, ptr %o11
  %t23 = load ptr, ptr %o2
  call void @llvm.memcpy.p0.p0.i64(ptr %o12, ptr %t23, i64 ptrtoint (ptr getelementptr ([128 x i32], ptr null, i64 1) to i64), i1 false)
...
bb46:
  %t50 = getelementptr [128 x i32], ptr %o12, i64 0, i64 %t48
