...
%Frame = type { [256 x i32], [256 x float], [256 x float], { ptr, ptr }, [256 x float], { ptr, i32 }, float, float, { ptr, i32 }, float, float }
...
entry:
  ...
  %t8 = call [256 x float] @fn1({ ptr, ptr } %t7)
  store [256 x float] %t8, ptr %o6
  ...
  %t14 = getelementptr [256 x float], ptr %o6, i64 0, i64 %t13
  ...
  %t19 = getelementptr [256 x float], ptr %o6, i64 0, i64 %t18
...
bb2:
  ...
  %t9 = getelementptr [256 x float], ptr %o3, i64 0, i64 %t4
...
entry:
  ...
  call void @flow_par_task(ptr %h, i32 0, i32 1, ptr @task0, i64 256, i32 513)
  call void @flow_par_task(ptr %h, i32 1, i32 0, ptr @task1, i64 9, i32 1)
  call void @flow_par_task(ptr %h, i32 2, i32 1, ptr @task2, i64 256, i32 257)
  call void @flow_par_task(ptr %h, i32 3, i32 1, ptr @task3, i64 256, i32 257)
