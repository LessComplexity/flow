...
struct FlowProd_float_int32_tp {
    float f0;
    int32_t* f1;
};
static_assert(sizeof(FlowProd_float_int32_tp) == 16, "FlowProd_float_int32_tp: abi_sizeof drift (plan-smart-arenas)");
...
static __device__ float d_fn3(FlowProd_floatp_int32_t_floatp_int32_t_float_int32_t in) {
  FlowProd_floatp_int32_t_floatp_int32_t_float_int32_t o0;
  float o1;
  float* o2;
  int32_t o3;
  float* o4;
  ...
  int32_t o11;
  FlowProd_floatp_int32_t o12;
  float o13;
  FlowProd_int32_t_int32_t o14;
  int32_t o15;
  FlowProd_int32_t_int32_t o16;
  int32_t o17;
  FlowProd_floatp_int32_t o18;
  float o19;
  FlowProd_float_float o20;
  float o21;
  FlowProd_float_float o22;
  o0 = in;
  o2 = o0.f0;
  o3 = o0.f1;
  o4 = o0.f2;
...
static __device__ float d_fn4(FlowProd_int32_tp_floatp_floatp_int32_t in) {
  FlowProd_int32_tp_floatp_floatp_int32_t o0;
  float o1;
  int32_t* o2;
  float* o3;
  float* o4;
  ...
  FlowProd_int32_t_int32_t o8;
  int32_t o9;
  FlowProd_float_int32_tp o10;
  float o11;
  int32_t* o12;
  FlowProd_floatp_int32_t_floatp_int32_t_float_int32_tp o13;
  o0 = in;
  o2 = o0.f0;
  o3 = o0.f1;
  o4 = o0.f2;
  ...
  o13.f3 = o9;
  float t0 = o13.f4;
  for (unsigned long long t1 = 0; t1 < 512ULL; t1++) {
...
static void flow_main() {
  ...
  float* t0 = nullptr;
  float* t1 = nullptr;
  cu_check(cudaMalloc((void**)&arena0, 4196864ULL), "cudaMalloc(arena0)");
  ...
  k0_0<<<(unsigned int)((262144ULL + 255ULL) / 256ULL), 256>>>(o2, 262144);
  ...
  o5 = (int32_t*)(arena0 + 1048576ULL);
  cu_check(cudaEventRecord(fev1_start), "cudaEventRecord");
  k0_0<<<(unsigned int)((512ULL + 255ULL) / 256ULL), 256>>>(o5, 512);
  ...
  o8.f1 = 0;
  o12.f1 = 262143;
  o3 = (float*)(arena0 + 1050624ULL);
  cu_check(cudaEventRecord(fev2_start), "cudaEventRecord");
  k0_2<<<(unsigned int)((262144ULL + 255ULL) / 256ULL), 256>>>(o3, o2);
  ...
  o4 = (float*)(arena0 + 2099200ULL);
  cu_check(cudaEventRecord(fev3_start), "cudaEventRecord");
  k0_3<<<(unsigned int)((262144ULL + 255ULL) / 256ULL), 256>>>(o4, o2);
  ...
  o6.f1 = o3;
  o6.f2 = o4;
  o7 = (float*)(arena0 + 3147776ULL);
  cu_check(cudaEventRecord(fev4_start), "cudaEventRecord");
  k0_4<<<(unsigned int)((262144ULL + 255ULL) / 256ULL), 256>>>(o7, o2, o5, o3, o4);
  ...
  t1 = (float*)(arena0 + 4196608ULL);
  cu_check(cudaEventRecord(fev6_start), "cudaEventRecord");
  k0_5<<<1, 1>>>(t1, o7, (int64_t)262143);
  ...
  flow_perf_total += flow_perf_ms;
  printf("FLOW_PERF launch=k0_5 ms=%.4f\n", flow_perf_ms);
  cu_check(cudaMemcpy(&o13, t1, sizeof(float), cudaMemcpyDeviceToHost), "cudaMemcpy(index)");
  o10 = o9;
  o14 = o13;
  flow_print_f32(o10, true);
