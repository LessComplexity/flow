...
static __device__ double d_fn3(FlowProd_doublep_int32_t_doublep_int32_t_double_int32_t in) {
  ...
  o4 = in.f2;
  o7 = in.f5;
  int64_t t0 = (int64_t)((int32_t)((uint32_t)((int32_t)((uint32_t)in.f1 * (uint32_t)4)) + (uint32_t)o7));
...
static __device__ double d_fn4(FlowProd_int32_tp_doublep_doublep_int32_t in) {
  ...
  pair.f2 = o10.f2;
  pair.f3 = o10.f3;
  for (unsigned long long t1 = 0; t1 < 4ULL; t1++) {
    pair.f4 = t0;
    pair.f5 = o2[t1];
    t0 = d_fn3(pair);
  }
...
static void flow_main() {
  ...
  k0_0<<<(unsigned int)((16ULL + 255ULL) / 256ULL), 256>>>(o2, 16);
  o3 = (int32_t*)(arena0 + 256ULL);
  k0_0<<<(unsigned int)((4ULL + 255ULL) / 256ULL), 256>>>(o3, 4);
  o4 = (double*)(arena0 + 512ULL);
  k0_2<<<(unsigned int)((16ULL + 255ULL) / 256ULL), 256>>>(o4, o2);
  o5 = (double*)(arena0 + 768ULL);
  k0_3<<<(unsigned int)((16ULL + 255ULL) / 256ULL), 256>>>(o5, o2);
  o6.f3 = o2;
  o6.f0 = o3;
  o6.f1 = o4;
  o6.f2 = o5;
  o7 = (double*)(arena0 + 1024ULL);
  k0_4<<<(unsigned int)((16ULL + 255ULL) / 256ULL), 256>>>(o7, o2, o3, o4, o5);
  t0 = (double*)(arena0 + 1280ULL);
  k0_5<<<1, 1>>>(t0, o7, (int64_t)0);
  cu_check(cudaMemcpy(&o9, t0, sizeof(double), cudaMemcpyDeviceToHost), "cudaMemcpy(index)");
  t1 = (double*)(arena0 + 1536ULL);
  k0_5<<<1, 1>>>(t1, o7, (int64_t)15);
