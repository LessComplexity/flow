...
static void flow_main() {
  ...
  o5 = (int32_t*)(arena0 + 256ULL);
  k0_0<<<(unsigned int)((4ULL + 255ULL) / 256ULL), 256>>>(o5, 4);
  o8.f1 = 0;
  o12.f1 = 15;
  o3 = (double*)(arena0 + 512ULL);
  k0_2<<<(unsigned int)((16ULL + 255ULL) / 256ULL), 256>>>(o3, o2);
  o4 = (double*)(arena0 + 768ULL);
  k0_3<<<(unsigned int)((16ULL + 255ULL) / 256ULL), 256>>>(o4, o2);
  o6.f3 = o2;
  o6.f0 = o5;
  o6.f1 = o3;
  o6.f2 = o4;
  o7 = (double*)(arena0 + 1024ULL);
  k0_4<<<(unsigned int)((16ULL + 255ULL) / 256ULL), 256>>>(o7, o2, o5, o3, o4);
  o8.f0 = o7;
  o12.f0 = o7;
