...
static void flow_main() {
  ...
  o5 = (int32_t*)(arena0 + 262144ULL);
  k0_0<<<(unsigned int)((256ULL + 255ULL) / 256ULL), 256>>>(o5, 256);
  o8.f1 = 0;
  o12.f1 = 65535;
  o3 = (float*)(arena0 + 263168ULL);
  k0_2<<<(unsigned int)((65536ULL + 255ULL) / 256ULL), 256>>>(o3, o2);
  o4 = (float*)(arena0 + 525312ULL);
  k0_3<<<(unsigned int)((65536ULL + 255ULL) / 256ULL), 256>>>(o4, o2);
  o6.f3 = o2;
  o6.f0 = o5;
  o6.f1 = o3;
  o6.f2 = o4;
  o7 = (float*)(arena0 + 787456ULL);
  k0_4<<<(unsigned int)((65536ULL + 255ULL) / 256ULL), 256>>>(o7, o2, o5, o3, o4);
  o8.f0 = o7;
  o12.f0 = o7;
