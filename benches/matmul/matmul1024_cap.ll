...
entry:
  %o2 = alloca [1048576 x i32]
  %o3 = alloca [1024 x i32]
  %o4 = alloca [1048576 x double]
  %o5 = alloca [1048576 x double]
  %o6 = alloca { ptr, ptr, ptr, ptr }
  %o7 = alloca [1048576 x double]
  %o8 = alloca { ptr, i32 }
  %o9 = alloca double
  %o10 = alloca { ptr, i32 }
  %o11 = alloca double
...
bb10:
  %t13 = load i64, ptr %s9
  %t14 = icmp uge i64 %t13, 1024
  br i1 %t14, label %bb12, label %bb11
bb11:
  %t15 = trunc i64 %t13 to i32
  %t16 = getelementptr [1024 x i32], ptr %o3, i64 0, i64 %t13
...
bb12:
  ...
  store i32 1048575, ptr %t19
  store i64 0, ptr %s20
  br label %bb21
bb21:
  %t24 = load i64, ptr %s20
  %t25 = icmp uge i64 %t24, 1048576
  br i1 %t25, label %bb23, label %bb22
bb22:
  %t26 = getelementptr [1048576 x i32], ptr %o2, i64 0, i64 %t24
  %t27 = load i32, ptr %t26
  %t28 = call double @fn1(i32 %t27)
  %t29 = getelementptr [1048576 x double], ptr %o4, i64 0, i64 %t24
...
bb32:
  ...
  %t36 = icmp uge i64 %t35, 1048576
  br i1 %t36, label %bb34, label %bb33
bb33:
  %t37 = getelementptr [1048576 x i32], ptr %o2, i64 0, i64 %t35
  %t38 = load i32, ptr %t37
  %t39 = call double @fn2(i32 %t38)
  %t40 = getelementptr [1048576 x double], ptr %o5, i64 0, i64 %t35
...
bb47:
  ...
  %t51 = icmp uge i64 %t50, 1048576
  br i1 %t51, label %bb49, label %bb48
bb48:
  %t52 = getelementptr [1048576 x i32], ptr %o2, i64 0, i64 %t50
  ...
  %t61 = getelementptr [1048576 x double], ptr %o7, i64 0, i64 %t50
...
bb49:
  ...
  %t68 = getelementptr [1048576 x double], ptr %o7, i64 0, i64 %t67
  ...
  %t73 = getelementptr [1048576 x double], ptr %o7, i64 0, i64 %t72
