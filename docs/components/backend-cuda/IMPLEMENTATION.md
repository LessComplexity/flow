...
| L3 one shared ceiling | `flow_ir::loop_plan` consumed (never re-derived); `tests/gate.rs::nested_loop_is_unsupported` (hand-built multi-merge graph) | green |
