...
## Test coverage (68 in-crate)

Identity anchor (`identity.rs`, 5) · property battery (`property.rs`, 9: four
proptest suites × six per-pass/full/determinism/idempotence rows, plus adversarial
and sequential-lift regression pins) · example golden (`golden.rs`, 1) · const-fold
