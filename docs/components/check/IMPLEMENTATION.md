...
> Last reconciled: 2026-07-17 · ADR-0019 WP3 (crate built, 26 tests).
...
| §7.3 effects (incl. node-kind seq discrimination, CK5 theorem, pure-seq-in-branch clean, L1105-shadow documentation, T0201 span pins) | `flow-check/tests/effects.rs` | 9 |
