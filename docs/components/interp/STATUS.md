...
Status: tested
Last updated: 2026-07-18 · Session 13 (ADR-0021 `Update` eval arm + loop-driven matmul4 / fanout value-semantics contracts; `LoopPlan` derivation migrated to `flow_ir::loop_plan` — BL7 one source of truth, interp-local `derive_plan` deleted)
