//! The Mapal-Core parse tree (DESIGN §15): a **thin** tree — syntax + names +
...
//! (C3 / I5 / J5) — rendering belongs to `mapal-cli`. Every node carries a
...
pub enum StageKind {
    ...
    /// **not** a fanout: `seq` is Mapal-Core's keyword-marked block stage. Guard
