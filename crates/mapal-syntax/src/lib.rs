//! `mapal-syntax`: the Mapal-Core lexer.
//!
//! This crate provides a handwritten, error-recovering, total lexer for the
//! Mapal language (DESIGN `docs/components/syntax/DESIGN.md`). The public
...
//!   `Display`/terminal rendering lives here (that is `mapal-cli`'s job).
