...
//! and invariants I1–I3 hold; a Mapal-ish token-soup generator additionally
//! checks determinism.

mod support;

use mapal_syntax::{LexOutput, TokenKind, lex};
...
/// Build a Mapal-ish token soup: pieces joined with random whitespace.
...
proptest! {
    ...
    /// Mapal-ish soup: deterministic + I1–I4 hold.
    #[test]
