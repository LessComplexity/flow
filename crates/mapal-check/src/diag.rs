...
//! (reserved in mapal-syntax diag.rs). Diagnostics reuse
//! [`mapal_syntax::Diagnostic`] (pub fields, constructed directly); severity is
...
use mapal_syntax::{DiagCode, Diagnostic, Severity, SourceLoc};
