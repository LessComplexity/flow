...
use mapal_ir::{CategoryIr, FuncKind, IrBuilder, SourceLoc, Ty, Value, validate};
use mapal_syntax::{Program, SourceLoc as SynLoc};
...
/// loop. Uses the real parse → lower pipeline (dev-dep mapal-lower).
#[test]
