//! `flow-interp`: the Flow compiler's **fueled reference interpreter** — THE
//! ORACLE (interp DESIGN; ADR-0002 E1; ADR-0013 traps; ADR-0015 print/println;
//! ADR-0016 guard-first loops).
//!
//! It consumes a sealed, `validate()`-clean `flow_ir::CategoryIr` (borrowed, never
...
use flow_ir::{CategoryIr, FuncId, Ty};
