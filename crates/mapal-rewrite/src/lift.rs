...
//!
//! Analysis consumes [`mapal_ir::CategoryIr::loop_plan`] as the sole loop-shape
...
fn cloneable_invariant(ir: &CategoryIr, morph: &mapal_ir::Morphism) -> bool {
...
fn single_def(ir: &CategoryIr, o: ObjectId) -> Option<&mapal_ir::Morphism> {
